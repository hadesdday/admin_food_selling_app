...
import com.nlu.admin_food_selling_app.adapters.FoodAdapter;
import com.nlu.admin_food_selling_app.data.model.Food;
import com.nlu.admin_food_selling_app.data.model.FoodType;
import com.nlu.admin_food_selling_app.helper.RecyclerTouchListener;
        ...
        foodListFiltered.addOnItemTouchListener
                (new RecyclerTouchListener(this, foodListFiltered, new RecyclerTouchListener.ClickListener() {
                    ...
                    public void onTouch(View view, int position) {
                        Intent in = new Intent(FilteredFood.this, FoodByFoodIdActivity.class);
